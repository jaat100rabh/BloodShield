...
<html lang="en">
<head>
	<title>BloodShield Recipient Login</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					...
					<h4 style="color: #333"><center>Recipient Portal</center></h4>
				</div>

				<form action="recipient_auth.php" class="login100-form validate-form" method="POST">
